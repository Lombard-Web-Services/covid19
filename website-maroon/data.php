...
<div class="img-box">
<img src="images/dl-opendata.png" />
</div>
<div class="text-box">
...
<a href="https://github.com/Lombard-Web-Services/covid19" class="reply" target="_blank">Navigate</a>
    ...
    $('.lnkdn-share-button').click(function() {
		...
		hourofupdate = 8;
		 var hourofupdate;
		 // parse the update hour for the api update robot
		 hourofupdates = parseInt(hourofupdate);
		 // get hour 
		 gethourtoday = new Date().getHours();
		 today = new Date();
		 // get the yesterday or before yesterday date in function of the hour of update
		 if(gethourtoday<hourofupdates){
